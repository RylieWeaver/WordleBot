...
def test(
    ...
    test_correct, test_guess_mask, test_active_mask = [], [], []
        ...
        for attempt in range(1, max_attempts + 1):
            try:
                ...
                for mb in range(num_minibatches):
                    ...
                    test_guess_mask.append(guess_mask_minibatch)
    ...
    test_guess_mask = torch.cat(test_guess_mask, dim=0)  # [epoch_size, target_repeats, max_guesses+1, vocab_size]
